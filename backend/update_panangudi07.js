...
async function run() {
  // First show what's in PANANGUDI-07
  ...
  console.log(`Found ${data.length} Approved schedules in PANANGUDI-07 to update`);
  ...
  for (const row of data) {
    ...
    if (upErr) {
      console.log(`  ERROR week ${row.week_number}:`, upErr.message);
    } else {
