...
export default function GroupLoanAgreement() {
  ...
  const handleDownloadPDF = () => {
    ...
    const opt = {
      margin:       0,
      filename:     `${selectedCenter?.name || 'Center'}_Group_Loan_Agreement.pdf`,
        ...
        <header className="sticky top-0 z-40 bg-[#050508]/80 backdrop-blur-md border-b border-white/10 px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-emerald-500 hover:bg-emerald-600 text-white rounded-lg transition-colors text-sm font-semibold shadow-lg shadow-emerald-500/20"
            >
