        ...
        <header className="sticky top-0 z-40 bg-[#050508]/80 backdrop-blur-md border-b border-white/10 px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex gap-3">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-indigo-500 hover:bg-indigo-600 disabled:opacity-50 disabled:cursor-not-allowed text-white rounded-lg transition-colors text-sm font-semibold shadow-lg shadow-indigo-500/20"
            >
              <FaPrint /> Print / PDF
            </button>
          </div>
